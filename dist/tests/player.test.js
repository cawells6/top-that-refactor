...
describe('Player model', () => {
    ...
    test('setUpCards replaces upCards', () => {
        const cards = [{ value: 'A', suit: 'clubs' }];
        p.setUpCards(cards);
        expect(p.upCards).toEqual(cards);
    });
    test('setDownCards replaces downCards', () => {
        const cards = [{ value: '5', suit: 'diamonds' }];
        p.setDownCards(cards);
        expect(p.downCards).toEqual(cards);
    });
    describe('playing cards', () => {
        const handCard = { value: '10', suit: 'hearts' };
        const upCard = { value: 'J', suit: 'clubs' };
        const downCard = { value: '3', suit: 'spades' };
        beforeEach(() => {
    ...
    describe('empty checks', () => {
        const testCard = { value: '2', suit: 'hearts' };
        test('hasEmptyHand', () => {
