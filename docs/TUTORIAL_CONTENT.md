...
This file contains all the tutorial text/verbiage in an easy-to-edit format. After making changes here, update the main tutorial file using this as reference.
...
**Instruction:**
Your only mission? One-up your opponent and become the king! This game is all about outplaying, outsmarting, and seizing the moment. Let's dive into the mechanics so you can start dueling in no time. Click Next to begin your journey!
...
**Instruction:**
Here's the core rule: you must play higher than what's on the pile. The King played a 7, so you need better than 7. Time to <strong>top that with your 8!</strong>
...
- Use `<strong>` tags for emphasized actions (e.g., `<strong>Play your 3</strong>`)
- Keep apostrophes escaped in the actual code (e.g., `you\'re` becomes `you're` in this doc)
- Special characters like quotes should be handled properly when importing back to code
