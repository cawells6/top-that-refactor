...
import * as state from './state.js'; // Add `.js` extension
import { initializeSocketHandlers } from './socketHandlers.js'; // Add `.js` extension
...
} from './uiManager.js'; // Add `.js` extension
