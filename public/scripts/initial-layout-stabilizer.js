...
(function () {
  ...
  // All initial layout stabilization is now handled by CSS and preload/loaded classes.
  // This script is now a no-op for legacy compatibility and diagnostics only.
})();
